  ...
  return (
    <section id="details" className="py-10 ">
      <div className="dropdown lg:px-20 px-5 w-full mb-10 mx-auto ">
        <button
          tabindex="0"
          className=" btn btn-outline btn-primary hover:btn-secondary transition duration-500 gap-4 flex justify-center lg:px-10  lg:text-xl text-white"
        >
          Project Details
          <svg
        ...
        <div
          tabindex="0"
          className="dropdown-content bg-base-200 border border-primary rounded-lg mt-1"
        >
      ...
      <div className="carousel border-t border-b shadow-t w-full">
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <p
              onClick={prevSlide}
              className="btn btn-primary text-white btn-circle"
            >
              ❮
            </p>
            <p
