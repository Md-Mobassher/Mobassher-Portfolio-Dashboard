...
const Banner = () => {
    ...
    return (
        <section className="hero min-h-screen  lg:px-20">
            <div className="hero-content flex-col lg:flex-row-reverse justify-center items-center ">
                <div className='w-full lg:w-1/2 flex justify-center items-center'>
                    <img src={mobassher} className=" flex rounded-lg size-cover" alt='Mobassher'/>
                </div>
                <div className='w-full lg:w-2/3 pt-5 lg:pt-0 '>
                    <h1 className="lg:text-3xl text-2xl text-secondary font-bold mb-3 lg:mb-4">Hi,</h1>
                    <h1 className="lg:text-5xl text-3xl  font-bold mb-3 lg:mb-4">I am <span className='text-primary'>MOBASSHER</span></h1>
                    <h2 className="mb-3 lg:mb-4 lg:text-3xl text-2xl font-bold text-secondary ">Full-Stack Developer</h2>
                    ...
                    <div>
                        <button className='btn btn-primary hover:btn-secondary px-8 mt-6 mr-5 text-white transition duration-500' onClick={saveFile}>Download Resume</button>
                        
                        <Link to='/contact' className='btn btn-outline btn-primary hover:btn-secondary px-8 mt-8 text-secondary transition duration-500' >Hire Me</Link>
                    </div>
