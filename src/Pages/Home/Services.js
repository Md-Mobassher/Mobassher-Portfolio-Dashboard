    ...
    return (
        <section id='projects' className='my-16 lg:px-20'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-7 px-5'>
                <div className=' max-w-sm mx-auto flex-col justify-center items-center shadow-xl rounded-lg border-x-rose-600 p-5'>
                    <FaLaptopCode className='w-10 h-10 block mx-auto mb-6'></FaLaptopCode>
                    <div >
                ...
                <div className=' max-w-sm mx-auto  flex-col justify-center items-center shadow-xl rounded-lg border-x-rose-600 p-5'>
                    <RiCodeSSlashLine className='w-10 h-10 block mx-auto mb-6'></RiCodeSSlashLine>
                    <div >
                ...
                <div className=' max-w-sm mx-auto flex-col justify-center items-center shadow-xl rounded-lg border-x-rose-600 p-5'>
                    <BsCodeSquare className='w-10 h-10 block mx-auto mb-6'></BsCodeSquare>
                    <div >
                        <h2 className='text-primary font-semibold text-2xl text-center mb-4'>Customize Website</h2>
